The PlayBot works with Xchat/Hexchat and requires the python 2 or 3 plugin to be loaded.
...
playbot_v10-2single and playbot_v10-2multi are PlayBots for the IRC game MultiRPG https://multirpg.net/  
