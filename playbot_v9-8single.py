...
networklist = [ ["AyoChat",     "irc.ayochat.or.id",            False,  1,      6667,           6667,           "multirpg@venus.skralg.com"],  \
		...
		["Virtulus",    "virtulus.be.sexy",             True,   1,      "+6697",        "+6697",        "multirpg@B790DC3F.D0CDF40.88109D7.IP"], \
...
def loginstart():
	...
	# call main directly
	main(None)
	if rawstatsmode is True or rawstatsmode is True:
		hookmain()
...
def intervalcalc():
	...
	if botcheck is True:
		...
		if(bets < 5 and level >= 30 and webworks is True):
			interval = 60
		if(fights < 5 and ufightcalc >= 0.9 and level >= 10 and level <= 200 and singlefight is True and nolag is True and rawstatsmode is True and webworks is True):
			interval = 30
	hookmain()
